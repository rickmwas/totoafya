...
const variants = {
  primary: 'bg-[#2E5B47] text-white shadow-[0_8px_30px_rgba(0,71,255,0.25)] hover:shadow-[0_12px_40px_rgba(0,71,255,0.35)] hover:bg-[#0038CC]',
  ...
  success: 'bg-[#2E5B47] text-white shadow-[0_8px_30px_rgba(46,122,93,0.2)] hover:bg-[#266A4F]',
  amber: 'bg-[#F9A825] text-[#0A0A0A] hover:bg-[#E09820]',
  outline: 'bg-transparent text-[#2E5B47] border border-[#2E5B47] hover:bg-[#2E5B47]/5',
};
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2E5B47]/50',
