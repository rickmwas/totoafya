  ...
  if (isCaregiverOnly) {
    ...
    return (
      <div className="mx-4 mb-4 flex gap-2 flex-wrap">
        ...
        {childCount > 0 && (
          <div className="flex items-center gap-1.5 bg-[#2E5B47]/8 border border-[#2E5B47]/15 rounded-full px-3 py-1.5">
            <span className="text-[13px]">👶</span>
            <span className="text-[10px] font-bold text-[#2E5B47] tracking-wide uppercase">
  ...
  if (isPregnant) {
    return (
      <div className="mx-4 mb-4">
        <div className="flex items-center gap-2 bg-[#2E5B47]/6 border border-[#2E5B47]/15 rounded-full px-4 py-2 w-fit">
          <span className="text-[15px]">🤰</span>
          <span className="text-[11px] font-bold text-[#2E5B47] tracking-wide uppercase">
