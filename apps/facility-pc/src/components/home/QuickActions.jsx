...
const ACTIONS = {
  pregnant: [
    { to: '/anc',      photo: PHOTOS.anc,      Icon: HeartHandshake, color: '#2E5B47', en: 'ANC Visits',  sw: 'Ziara za ANC',  sub_en: 'Track your clinic',  sub_sw: 'Fuatilia kliniki' },
    ...
    { to: '/growth',   photo: PHOTOS.growth,   Icon: TrendingUp,     color: '#2E5B47', en: 'Growth',      sw: 'Ukuaji',        sub_en: 'Weight records',  sub_sw: 'Rekodi za uzito' },
  ],
  child: [
    { to: '/vaccines', photo: PHOTOS.vaccines, Icon: Shield,         color: '#2E5B47', en: 'Vaccines',    sw: 'Chanjo',        sub_en: 'Full schedule',   sub_sw: 'Ratiba kamili' },
    { to: '/growth',   photo: PHOTOS.growth,   Icon: TrendingUp,     color: '#2E5B47', en: 'Growth',      sw: 'Ukuaji',        sub_en: 'WHO charts',      sub_sw: 'Grafu ya WHO' },
  ...
  caregiver: [
    { to: '/vaccines', photo: PHOTOS.vaccines, Icon: Shield,         color: '#2E5B47', en: 'Vaccines',    sw: 'Chanjo',        sub_en: 'Vaccine schedule',sub_sw: 'Ratiba ya chanjo' },
    { to: '/growth',   photo: PHOTOS.growth,   Icon: TrendingUp,     color: '#2E5B47', en: 'Growth',      sw: 'Ukuaji',        sub_en: 'Track growth',    sub_sw: 'Fuatilia ukuaji' },
