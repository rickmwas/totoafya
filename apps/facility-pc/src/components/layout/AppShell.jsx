    ...
    <div className="min-h-screen bg-[#FAFBFB]">
      ...
      <nav className="hidden sm:flex items-center justify-between px-6 md:px-10 py-3 bg-white/90 backdrop-blur-xl border-b border-[#E8E4DC] sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-[10px] bg-[#2E5B47] flex items-center justify-center shadow-teal-glow-sm">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active ? 'bg-[#2E5B47] text-white shadow-teal-glow-sm' : 'text-[#666666] hover:bg-[#F0EDE6]'
                )}
              >
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active ? 'bg-[#2E5B47]' : 'bg-transparent'
                  )}
                >
