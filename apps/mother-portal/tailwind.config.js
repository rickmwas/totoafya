...
module.exports = {
  ...
  safelist: [
    "bg-[#1B6B5A]", "bg-[#2E7A5D]", "bg-[#E51010]", "bg-[#F9A825]", "bg-[#7C3AED]",
    "text-[#1B6B5A]", "text-[#2E7A5D]", "text-[#E51010]", "text-[#F9A825]", "text-[#7C3AED]",
    "border-[#1B6B5A]", "border-[#2E7A5D]", "border-[#E51010]", "border-[#F9A825]",
    "bg-[#1B6B5A]/10", "bg-[#2E7A5D]/10", "bg-[#E51010]/10", "bg-[#F9A825]/10", "bg-[#7C3AED]/10",
  ],
  theme: {
    extend: {
      fontFamily: {
      ...
      boxShadow: {
        ...
        'blue-glow': '0 8px 30px rgba(27,107,90,0.25)',
        'blue-glow-sm': '0 4px 16px rgba(27,107,90,0.18)',
