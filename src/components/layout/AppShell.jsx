...
export default function AppShell({ children }) {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <nav className="hidden sm:flex items-center justify-between px-6 md:px-10 py-3 bg-white/90 backdrop-blur-xl border-b border-[#E5E5E5] sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-[10px] bg-[#0047FF] flex items-center justify-center shadow-blue-glow-sm">
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-50">
        <div className="mx-3 mb-3 bg-white/90 backdrop-blur-xl rounded-[28px] border border-[#E5E5E5] shadow-float px-2 py-2">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active ? 'bg-[#0047FF]' : 'bg-transparent'
                  )}
                >
